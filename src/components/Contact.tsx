          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://www.linkedin.com/company/stem-computer-science-club/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-blue-700 hover:bg-blue-800 rounded-lg flex items-center justify-center text-white transition-colors duration-200 hover:scale-105 transform">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
