        ...
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.linkedin.com/company/stem-computer-science-club/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-white/10 hover:bg-blue-700 rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-105 hover:shadow-lg border border-white/10">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
